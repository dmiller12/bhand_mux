...
BhandMuxDiagnostics::BhandMuxDiagnostics() {
    diagnostic_.add("Bhand mux status", this, &BhandMuxDiagnostics::diagnostics);
    diagnostic_.setHardwareID("none");
}

BhandMuxDiagnostics::~BhandMuxDiagnostics() {}

void BhandMuxDiagnostics::update() { diagnostic_.update(); }

void BhandMuxDiagnostics::updateStatus(const status_type::ConstPtr &status) {
...
void BhandMuxDiagnostics::diagnostics(diagnostic_updater::DiagnosticStatusWrapper &stat) {
